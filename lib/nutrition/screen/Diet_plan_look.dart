...
class Diet_plan_look extends StatefulWidget {

  final String text;
  const Diet_plan_look({Key key, @required this.text}) : super(key: key);
  // This widget is the root of your application.
  @override
  State<Diet_plan_look> createState() => _Diet_plan_lookState();
}

class _Diet_plan_lookState extends State<Diet_plan_look> {
