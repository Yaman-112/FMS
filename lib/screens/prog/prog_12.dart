...
class prog_12 extends StatefulWidget {
  final String text;
  const prog_12({Key key, @required this.text}) : super(key: key);
  @override
  _prog_12State createState() => _prog_12State();
}




class _prog_12State extends State<prog_12> {
